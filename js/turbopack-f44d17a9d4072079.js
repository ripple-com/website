(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  "object" == typeof document ? document.currentScript : void 0,
  {
    otherChunks: [
      ...
      "static/chunks/6fc8155694fa8991.js",
  ...
  o.s = function(e, t) {
    ...
    let c = (n = l, o = s, (a = r.get(n)) || (r.set(n, a = []), n.exports = n.namespaceObject = new Proxy(o, {
      get(e, t) {
  ...
  g.prototype = URL.prototype, o.U = g, o.z = function(e) {
  ...
  async function k(e, t, r) {
    let n;
    if ("string" == typeof r) {
      if (r.endsWith(".wasm")) n = await this.loadWebAssembly(e, t, r);
      else if (r.endsWith(".wasm?module")) n = await this.loadWebAssemblyModule(e, t, r.slice(0, -7));
      else {
        let e = new URL(r, self.location.href);
        if (e.protocol === "file:" || e.protocol === "chrome-extension:") {
          let t = await fetch(r);
          if (!t.ok) throw Error(`Failed to load chunk: ${r}`);
          let o = await t.text();
          n = new Function("module", "exports", o)(this.m, this.e)
        } else n = await import(r)
      }
    } else n = r;
    return n
  }
  ...
  function x(e, t, r) {
    let o = C.get(e);
    "function" != typeof o && function(e, t, r) {
      let n;
      switch (t) {
        case 0:
      ...
      throw Error(`Module ${e} was instantiated ${n}, but the module factory is not available. It might have been deleted in an HMR update.`)
    }(e, t, r);
    let i = a(e),
      l = i.exports;
    K[e] = i;
  ...
  (() => {
    ...
    e = {
      ...
      loadChunkCached: (e, r) => (function(e, r) {
        let n = t(r);
        if (n.loadingStarted) return n.promise;
        if (e === j.Runtime) return n.loadingStarted = !0, E(r) && n.resolve(), n.promise;
        if ("function" == typeof importScripts)
          if (E(r));
          else if (A.test(r)) self.TURBOPACK_NEXT_CHUNK_URLS.push(r), importScripts(TURBOPACK_WORKER_LOCATION + r);
        else throw Error(`can't infer type of chunk from URL ${r} in worker`);
        else {
          let e = decodeURI(r);
          if (E(r))
            if (document.querySelectorAll(`link[rel=stylesheet][href="${r}"],link[rel=stylesheet][href^="${r}?"],link[rel=stylesheet][href="${e}"],link[rel=stylesheet][href^="${e}?"]`).length > 0) n.resolve();
            else {
              let e = document.createElement("link");
              e.rel = "stylesheet", e.href = r, e.onerror = () => {
                n.reject()
              }, e.onload = () => {
                n.resolve()
            ...
            let t = document.querySelectorAll(`script[src="${r}"],script[src^="${r}?"],script[src="${e}"],script[src^="${e}?"]`);
            if (t.length > 0)
              for (let e of Array.from(t)) e.addEventListener("error", () => {
                n.reject()
              });
            else {
...
(function() {
  ...
  s.setAttribute("data-deployment-id", "dpl_EfKJpX4zxbHWiNiW4SR1enTy7bdQ");
